...
<body>
        ...
        <div class="row">
            ...
            ?><script>
                    ...
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title"><a href="viewProdList.php?catid=' . $catId . '">' . $catname . '</a></h5>
                            <p class="card-text">' . substr($catdesc, 0, 29) . '...</p>
                            <a href="viewProdList.php?catid=' . $catId . '" class="btn btn-primary">View All</a>
                        </div>
                    </div>
                </div>';
                        }
    ...
    <div class="container my-3" id="cont">
        ...
        <div class="row">
            <?php
            $query = $_GET["search"];
            $sql = "SELECT * FROM `prod` WHERE MATCH(prodName, prodDesc) against('$query')";
            $result = mysqli_query($conn, $sql);
            while ($row = mysqli_fetch_assoc($result)) {
            ?><script>
                    document.getElementById("iteam").innerHTML = "Items: ";
                            ...
                            echo '<div class="col-xs-3 col-sm-3 col-md-3">
                    <div class="card" style="width: 18rem;">
                        <img src="img/prod-' . $prodId . '.jpg" class="card-img-top" alt="image for this product" width="249px" height="270px">
                        <div class="card-body">
                            <h5 class="card-title">' . substr($prodName, 0, 20) . '...</h5>
                            <h6 style="color: #ff0000">PHP ' . $prodPriceM . '/-</h6>
                            <h6 style="color: #ff0000">PHP ' . $prodPriceL . '/-</h6>
                            <p class="card-text">' . substr($prodDesc, 0, 29) . '...</p>
                            ...
                            echo '</form>
                                <a href="viewProd.php?prodid=' . $prodId . '"><button class="btn btn-primary">Quick View</button></a>
                            </div>
                        </div>
                    </div>
                </div>';
