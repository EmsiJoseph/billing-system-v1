...
$sql = "SELECT orderId, amount, orderStatus, queueNumber, orderDate FROM orders ORDER BY orderDate DESC";
...
<head>
    ...
    <style>
        .board {
            ...
            margin-top: 20px;
            position: relative;
            /* Ensures that the child elements (columns) can be absolutely positioned relative to this container */
        }

        .vertical-divider {
            border-right: 4px solid white;
            position: absolute;
            /* Positions the dividers absolutely within the 'board' */
            top: 10px;
            /* Adds a small space at the top */
            bottom: 10px;
            /* Adds a small space at the bottom */
            right: 0;
            /* This will need to be adjusted per column in the HTML */
        }

        .column {
            height: 100%;
            padding-right: 4px;
            /* Ensures padding for the divider */
        }
